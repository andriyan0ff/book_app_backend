        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                if len(data) != 0:
                    with connection.cursor() as cursor:
                        cursor.execute("""
                        UPDATE users SET country = NULL WHERE country = '""" + str(params["id"]) + """';
                        DELETE FROM country WHERE id = '""" + str(params["id"]) + """';
                        """)
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                if len(data) != 0:
                    with connection.cursor() as cursor:
                        cursor.execute(
                            """UPDATE country SET name = '""" + str(params["name"]) + """' 
                            WHERE id = '""" + str(params["id"]) + """';""")
                    return "Country id = " + params["id"] + " Updated", 200
                else:
